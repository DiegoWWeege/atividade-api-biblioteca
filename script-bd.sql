...
-- Schema biblioteca-api
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS biblioteca_api_diego DEFAULT CHARACTER SET utf8 ;
USE biblioteca_api_diego;
-- -----------------------------------------------------
-- Table biblioteca-api.livro
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS biblioteca_api_diego.livro (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS biblioteca_api_diego.usuario (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS biblioteca_api_diego.emprestimo (
  ...
  CONSTRAINT fk_emprestimo_livro
    ...
    REFERENCES biblioteca_api_diego.livro (id_livro)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_emprestimo_usuario1
    FOREIGN KEY (usuario_id)
    REFERENCES biblioteca_api_diego.usuario (id_usuario)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
